...
<div class="header">
  <div>
    <div class="brand-name">MediVerify</div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="bg-[#1a1a2e] px-6 py-4 flex items-center justify-between">
                    <div>
                        <p className="text-[21px] font-black text-white tracking-tight leading-none">MediVerify</p>
                ...
                <div className="bg-white overflow-y-auto max-h-[68vh]">
                    ...
                    <div className="px-6 pb-5 text-center">
                        <p className="text-[9px] text-gray-400 italic">
                            This report is digitally signed by MediVerify nodes. Any tampering invalidates the verification.
                        </p>
                    </div>
                </div>
...
<div class="footer">This report is digitally generated by MediVerify. Any tampering invalidates the verification.</div>
</body>
</html>`;
        ...
        a.href = url;
        a.download = `MediVerify-Manufacturer-${report.companyName.replace(/\s+/g, "-")}-${Date.now()}.html`;
        a.click();
