...
export const Route = createAPIFileRoute("/api/admin/manufacturers/$id/restore")({
    POST: async ({ request, params }: { request: Request; params: { id: string } }) => {
        try {
            ...
            return Response.json(ApiResponse.success(manufacturer, "Manufacturer restored successfully."));
        } catch (error: any) {
